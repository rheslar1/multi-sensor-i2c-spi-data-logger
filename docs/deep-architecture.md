# Multi-Sensor Data Logger over I2C/SPI Deep Architecture
...
C++17, C++ Design Patterns, SOLID, I2C, SPI, POSIX threads, SQLite, C/C++, Sensor logging
...
- Test coverage: `tests/DataLoggerTests.cpp`
