...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for Multi-Sensor Data Logger over I2C/SPI. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: Multi-threaded C/C++ Linux data logger that reads temperature, pressure, and humidity sensors through /dev/i2c-* or /dev/spidev* and stores records in SQLite. | Scenario tests and documentation review. |
